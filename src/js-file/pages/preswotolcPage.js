...
export default class preswotolcPage extends Component {
    constructor(props) {
        super(props)
        // State
        this.state = {
        ...
        return (
            <div>
                ...
                <div className="linkback">
                    <p onClick={() => { this.props.history.push('https://mgtstudent.github.io/swot-website/'); window.scrollTo(0, 0) }}>HOME > SWOT & OLC > {" "}
                    ...
                    <div className="swot-infobox">
                        ...
                        <p style={{ marginTop: "10%" }}>
                            ...
                            <span style={{ color: "#363C54" }}>
                                ...
                                รายได้ของธุรกิจนี้คือรายได้จากการขาย การจัดทำรายงานทางการเงินค่อนข้างที่จะยุ่งยาก
                                เนื่องจากต้องคำนวณต้นทุนการผลิตค่อนข้างซับซ้อน เช่น ร้านชานมไข่มุกที่มีการผลิตไข่มุกจำหน่ายเอง 
                                ร้านเบเกอรี่ ร้านขายขนมไทย ร้านขายลูกชิ้นที่ผลิตลูกชิ้นด้วยโรงงานของตนเอง
